...
\section{Starting example}
		...
		\subsection{Download a toy data-set}	
			...
			\url{https://nextcloud.univ-lille.fr/remote.php/webdav/MPAgenomics/BirdSuite/birdsuite_input.tgz}
...
setwd(workdir)
#download file
download.file("https://nextcloud.univ-lille.fr/remote.php/webdav/MPAgenomics/BirdSuite/birdsuite_input.tgz",
